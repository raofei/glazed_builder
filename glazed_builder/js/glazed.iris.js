...
( function( $, undef ){
    ...
    // @todo escape if variable is missing
    // @todo move this to other script so we can auto-update
    // https://github.com/WordPress/WordPress/blob/master/wp-admin/js/color-picker.js
    var drupal_palette = [];
    for (var o in window.sooperthemes_theme_palette) drupal_palette.push(window.sooperthemes_theme_palette[o]);
